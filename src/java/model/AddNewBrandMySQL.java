 ...
 * @author march
 */
@WebServlet(name = "AddNewBrandMySQL", urlPatterns = {"/AddNewBrandMySQL"})
public class AddNewBrandMySQL extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if(!dbConnection.insertNewBrand(brand)){
            System.out.println(">>> AddNewBrandMySQL ERROR");
        }
        ...
        RequestDispatcher rd = sc.getRequestDispatcher("/addBrand.jsp");
